      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-sky-500/10 border border-sky-500/20 text-sky-400 text-xs font-mono">
            ...
            <span>THE MENTOR & THE METHODOLOGY</span>
          </div>
          <h2 className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight">
            Trading Journey & Philosophy
          </h2>
          <p className="text-base text-slate-400 leading-relaxed">
            The authentic path of Ajay Gadhe (AjayTrades77 / AJT77): From retail misconceptions to systematic institutional price action, disciplined execution, and transparent mentorship.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-4 flex flex-col items-center text-center lg:items-start lg:text-left space-y-4">
              <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl bg-gradient-to-tr from-sky-500 to-indigo-600 p-1 shadow-xl shadow-sky-950/80">
                <div className="w-full h-full bg-[#090d16] rounded-[14px] flex items-center justify-center">
                  <span className="text-4xl font-extrabold text-white tracking-tight">AG</span>
                </div>
              </div>
              <div>
                <h3 className="text-2xl font-bold text-white">Ajay Gadhe</h3>
                <p className="text-sm font-mono text-sky-400 mt-0.5 font-semibold">Founder • AjayTrades77 • AJT77</p>
                <p className="text-xs text-slate-400 mt-2">Full-Time Price Action Trader & Educator</p>
              </div>
            </div>
            ...
            <div className="lg:col-span-8 space-y-4 text-slate-300 text-sm sm:text-base leading-relaxed border-t lg:border-t-0 lg:border-l border-slate-800 lg:pl-8 pt-6 lg:pt-0 font-normal">
              <p className="text-slate-200">
                &ldquo;Trading is not about predicting every move. It is about understanding price, waiting for the right conditions, managing risk, and executing with discipline.&rdquo;
              </p>
              <p className="text-slate-300">
                AJT77 is built around a simple philosophy: learn the market before trying to master it. My approach focuses on price action, market structure, liquidity, ICT &amp; SMC concepts, multi-timeframe analysis, and disciplined risk management.
              </p>
              <p className="text-slate-400">
                The goal is not shortcuts or unrealistic promises. The goal is to build a clear process, develop consistency, and make decisions with greater confidence and control.
              </p>
            </div>
          </div>
        </div>
