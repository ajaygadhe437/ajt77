      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-base text-slate-400 leading-relaxed">
            Engineered by Ajay Gadhe (AJT77) to eliminate guesswork, master market structure, and establish rigorous risk-adjusted trading habits.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="relative rounded-2xl bg-[#0b0f19] border border-slate-700/80 p-8 flex flex-col justify-between hover:border-slate-600 transition-all shadow-xl">
              ...
              <div className="flex justify-between items-start">
                <div>
                  <span className="text-xs font-mono font-bold uppercase tracking-wider text-sky-400 px-2.5 py-1 bg-sky-500/10 rounded-md border border-sky-500/20">
                    Zero to 100 Foundation
                  </span>
                  <h3 className="text-2xl font-bold text-white mt-3">AJT77 Basic</h3>
                  <p className="text-xs text-slate-400 mt-1">Beginner to Advanced Trading Education</p>
                </div>
              </div>

              {/* Price */}
              <div className="flex items-baseline space-x-2 pt-2 border-b border-slate-800 pb-6">
                <span className="text-4xl sm:text-5xl font-extrabold text-white tracking-tight">₹6,000</span>
            ...
            <div className="pt-8 space-y-3">
              ...
              >
                <span>Enroll in AJT77 Basic (₹6,000)</span>
                <ArrowRight className="w-4 h-4 text-sky-400" />
              </button>

              <button
                onClick={() => {
                  setEnquiryCourse('AJT77 Basic');
          ...
          <div className="relative rounded-2xl bg-[#0d1222] border-2 border-sky-500/80 p-8 flex flex-col justify-between shadow-2xl shadow-sky-950/60 transition-all">
            ...
            <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
              <span className="text-[11px] font-extrabold uppercase tracking-wider px-3.5 py-1 bg-gradient-to-r from-sky-500 via-indigo-500 to-cyan-400 text-white rounded-full shadow-md">
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-white mt-3">AJT77 Pro</h3>
                  <p className="text-xs text-slate-400 mt-1">Advanced Execution & Daily Setup Guidance</p>
                </div>
              </div>
            ...
            <div className="pt-8 space-y-3">
              ...
              >
                <span>Enroll in AJT77 Pro (₹10,000)</span>
                <ArrowRight className="w-4 h-4" />
              </button>

              <button
                onClick={() => {
                  setEnquiryCourse('AJT77 Pro');
                  setEnquiryModalOpen(true);
                }}
                className="w-full py-2 text-xs text-slate-400 hover:text-slate-200 transition-colors"
              >
